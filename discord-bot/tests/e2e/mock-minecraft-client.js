...
class MockMinecraftClient extends EventEmitter {
  ...
  balance_response(query_id, username, balance, success, message = '') {
    return this.send({
      type: 'balance_response',
      payload: { query_id, username, balance, success, message }
    });
  }

  shop_stats_response(query_id, username, shops, success, message = '') {
    return this.send({
      type: 'shop_stats_response',
      payload: { query_id, username, shops, success, message }
    });
  }

  rich_list_response(query_id, players, success, message = '') {
    return this.send({
      type: 'rich_list_response',
      payload: { query_id, players, success, message }
    });
  }
