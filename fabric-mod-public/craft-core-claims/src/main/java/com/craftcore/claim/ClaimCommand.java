...
public class ClaimCommand {
                    ...
                    .then(Commands.literal("ban")
                            .then(Commands.argument("target", StringArgumentType.string())
                                    ...
                                    .executes(context -> {
                                        ...
                                        if (claim.banned_players == null) claim.banned_players = new ArrayList<>();
    ...
    private static int handleAcceptTransfer(CommandContext<CommandSourceStack> context) {
        ...
        double balance = EconomyAPI.getProvider().getBalance(receiverName);
        if (balance < 30.0) {
        ...
        EconomyAPI.getProvider().removeMoney(receiverName, 30.0);
