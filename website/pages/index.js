    ...
    <div className="min-h-screen flex flex-col bg-white text-zinc-800">
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl text-white">
          ...
          <p className="text-sm md:text-base font-medium opacity-90 mb-8 max-w-lg mx-auto leading-relaxed">
      ...
      <main className="max-w-4xl w-full mx-auto px-4 py-16 flex flex-col items-center">
        ...
        <section className="w-full max-w-3xl border border-zinc-200 bg-zinc-50 rounded-xl overflow-hidden shadow-sm p-4 mb-20 text-center">
          <h3 className="text-xs font-black text-zinc-400 uppercase tracking-wider mb-3">📡 伺服器即時狀態</h3>
          <div className="bg-black flex items-center justify-center p-2 rounded-lg border border-zinc-200 shadow-inner">
            <img 
        ...
        <section className="w-full max-w-3xl text-center mb-16">
          <h2 className="text-2xl font-black tracking-tight mb-8">🎯 立即加入伺服器</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-6 text-left flex flex-col justify-between">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between px-3 py-2 bg-white border border-zinc-200 rounded-lg text-xs font-mono text-zinc-700">
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-6 text-left flex flex-col justify-between">
              <div>
                <div className="flex items-center space-x-2 text-blue-600 mb-2">
                  <span className="text-xs font-extrabold bg-blue-100 px-2 py-0.5 rounded">基岩版 (BE)</span>
                </div>
                <p className="text-xs text-zinc-500 mb-6 leading-relaxed">
      ...
      {/* Footer */}
      <footer className="w-full border-t border-zinc-200 bg-zinc-50 py-8 text-xs text-zinc-400">
