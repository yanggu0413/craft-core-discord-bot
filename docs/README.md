...
* **遊戲伺服器**：進行箱子商店買賣、框選領地、密碼鎖設定、每日任務與限時伺服器活動。
* **Discord 機器人**：進行每日簽到、福利抽獎、查看商店狀況、公共設施審核與發送快遞。
* **網頁儀表板**：在網頁上直觀查看全服富豪排行榜、熱門伺服器活動、管理您的領地權限與密碼箱、閱讀實時交易廣播。
...
### 🖥️ 1. 網頁端儀表板使用指南
* 🖥️ [網頁版首頁簡介](Web-Dashboard.md) — 首頁各項即時看板、熱門活動橫幅與帳號登入綁定。
...
* 🎪 [伺服器活動系統](Mc-Server-Events.md) — 遊戲內與網頁端限時活動玩法、時間與獎勵。
...
* 🧭 [遊戲內傳送與 TP 指令](Mc-Teleport-Commands.md) — `/home` (含額外家園 $300 扣費規則)、`/tpa`、`/warp` 及公共設施審核。
* 🤖 [Carpet 假人掛機系統](Mc-Fake-Player.md) — `/fp` 假人召喚、動作遙控與 Tab 稱號標示。
* 🛠️ [管理員指令與權限](Mc-Admin-Management.md) — 管理員無限商店、加扣錢、Discord 審核與 Web 主控台維護指令。

### 🤖 3. Discord 機器人連動
* 🤖 [Discord 連動綁定](Discord-Integration.md) — 綁定 Minecraft 帳號、5 大控制面板與公共設施審核。
