...
伺服器為所有玩家提供了安全、便捷的假人掛機系統，讓您可以在不需要開啟多個 Minecraft 客戶端的情況下，召喚假人登入伺服器掛網、自動刷怪、測試紅石與收集物資。
...
您可以在選單大廳的 **`/menu -> 🤖 假人控制台`** 分頁中方便管理假人：
1. **即時名冊**：顯示您擁有的假人列表、名稱與在線狀態。
2. **快捷按鈕**：點擊假人開啟 54-槽位控制選單，一鍵提供連續攻擊、右擊使用、停止動作、傳送至身邊以及開啟 `/invsee` 背包管理！
