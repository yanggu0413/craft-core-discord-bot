...
- **語言與環境**: Java 25 / Fabric Loader (Minecraft 26.2)。
- **建置命令**: `./gradlew build` ➔ 產出 `build/libs/craft-core-mod-2.5.8.jar`。
...
|---|---|---|
| 👑 **Fabric 伺服器 (主)** | `/opt/mcsmanager/daemon/data/InstanceData/e73c05307a6b4259bd052b88706757df/` | **服主主要營運伺服器**。模組放置於 `mods/craft-core-mod-2.5.8.jar`。資料檔位於 `config/craft-core-shop/`。 |
